...
local tela_inicial = {
    ...
    update = function(dt)
        ...
        if suit.Button("Iniciar", suit.layout:row(300,30)).hit then
            if mostrar_regras == 0 then
                suit.Label(nome .. ", você deseja saber as regras?")
...
function love.load(args)
    GameStateManager:setState(tela_inicial)
end
